...
setup(name='jake',
		...
		ext_modules = 
		[
			Extension('pyjake', ['src/pyjake.cpp'], include_dirs=['../jake_driver/inc', 'inc'], library_dirs=['../jake_driver'], libraries=['bluetooth', 'jake_driver'], define_macros = [('PYJAKE_COMPILE', '1')]
			)
		]
)
